"""
Service module for handling user logout and session termination.
"""
...
async def user_logout_controller(
    request: Request, response: Response, db_session: AsyncSession
):
    """
    Handles the user logout process.
    Revokes the refresh token in the database and clears the refresh token cookie.
    """
    try:
